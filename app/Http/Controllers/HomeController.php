...
<p>$site_msg</p>
     ...
     */
    public
    function SEOByLang($lang = "", $seo_url_slug = 0)
    {
        if ($lang != "") {
            // Set Language
            App::setLocale($lang);
...
// Home Partners
     ...
     */
    public
    function topicsByLang($lang = "", $section = 0, $cat = 0)
    {
     ...
     */
    public
    function topicByLang($lang = "", $section = 0, $id = 0)
    {
     ...
     */
    public
    function topics($section = 0, $cat = 0)
    {
        $lang_dirs = array_filter(glob(App::langPath() . '/*'), 'is_dir');
        // check if this like "/ar/blog"
        if (in_array(App::langPath() . "/$section", $lang_dirs)) {
     ...
     */
    public
    function userTopicsByLang($lang = "", $id)
    {
     ...
     */
    public
    function searchTopics(Request $request)
    {
     ...
     */
    public
    function ContactPageByLang($lang = "")
    {
     ...
     */
    public
    function ContactPageSubmit(Request $request)
    {
     ...
     */
    public
    function subscribeSubmit(Request $request)
    {
